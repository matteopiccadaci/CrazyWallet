...
<html>
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
         <?php if(!(retreive_quantity($_SESSION['id'])<0 || retreive_quantity($_SESSION['id'])==null))
      ...
      <!-- Come reperibile nei docs di Apexcharts, ogni grafico deve essere compreso all'interno di un div. -->
        <div id="contenitore" class="row">
            ...
            if(retreive_quantity($_SESSION['id'])<0 || retreive_quantity($_SESSION['id'])==null){
                echo '<div id="rendimento" class="card-body"><h1>Benvenuto!</h1>&nbsp;<h5>Effettua il tuo primo acquisto nella sezione "Nuovo asset"</h5></div>';
            } //Viene controllato se l'utente ha effettuato almeno un acquisto, in caso contrario viene mostrato un messaggio di benvenuto.
            else {
                echo '<div class="card" id = "piediv" style="margin-top: 1%">
            <div class="card-body"  >
  ...
  <?php
  if(!(retreive_quantity($_SESSION['id'])<0 || retreive_quantity($_SESSION['id'])==null)) {
        echo '<div id="chartdiv" class="card" style="width: 100%;">
            <div class="card-body">';
                    ...
                    echo '</select>';
                } //Viene mostrato un menù a tendina con tutti gli asset dell'utente solo se ne ha almeno uno.
        ...
        <script>
            ...
            //Ajax per il grafico di rendimento giornaliero che viene mostrato in base all'asset selezionato dall'utente.
        </script>
  </body>
</html>
