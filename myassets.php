...
if(isset ($_GET['ajax'])){
    ...
    if($_GET['ajax']==1 || $_GET['ajax']==2 || $_GET['ajax']==3 || $_GET['ajax']==4){
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 id="asset_dash" class="h2"></h1>
                <div class="btn-toolbar mb-2 mb-md-0">

                    <!-- popolamento select con le azioni e gli ETF -->

                    <?php
                        echo ' <select id="asset"class="form-select"aria-label=".form-select-lg example" style="width: 52%;"> 
                <option selected disabled>I tuoi asset</option>';
                        ...
                        echo "</select>";
                        echo '<select id="timeframe"class="form-select"aria-label=".form-select-lg example" style="width: 48%">
